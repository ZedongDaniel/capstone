from cnn.cnn1d import ConvAutoencoder
import torch
import pandas as pd
import json
import numpy as np
...
if __name__ == "__main__":
    model = CnnSeqAutoEncoderModel(model_path="models/2024_1101_cnn1d_seq.pth",
                        data_path="data/test_data.csv",
                        threshold_dict="sector_threshold.json")
    model.set_threold("mae.json", 0.99)
