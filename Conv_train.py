from Conv_model import AutoencoderDataset, ConvAutoencoder
...
if __name__ == "__main__":
    ...
    seq_n = 100
    train_dataset = AutoencoderDataset(train_df, seq_n)
    valid_dataset = AutoencoderDataset(valid_df, seq_n)
