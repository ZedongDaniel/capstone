import json
from model import CnnChannelAutoEncoder
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
from dynamic_thresholds import compute_rolling_vol,vol_regimes, detect_anomalies_sample, detect_anomalies_index
...
if __name__ == "__main__":
    model = CnnChannelAutoEncoder('CnnChannelModel/2024_11_06_cnn1d_channel.pth')
    detector = CnnAnomalyDetector(model=model, threshold_config = 'CnnChannelModel/threshold_config.json')
    detector.load_data('data/test_data.csv')
